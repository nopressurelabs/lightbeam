...
Connection.PATH = 2;
Connection.SPEC = 3;
Connection.HEADERS = 4;
Connection.TIMESTAMP = 5;
Connection.CONTENT_TYPE = 6;
Connection.COOKIE = 7;
Connection.SOURCE_VISITED = 8;
Connection.SECURE = 9;
Connection.SOURCE_PATH_DEPTH = 10;
Connection.SOURCE_QUERY_DEPTH = 11;
Connection.SOURCE_SUB = 12;
Connection.TARGET_SUB = 13;
Connection.METHOD = 14;
Connection.STATUS = 15;
Connection.CACHEABLE = 16;
Connection.FROM_PRIVATE_MODE = 17;
